...
#include <ctime>
#include <string>
#include <limits> // NECESARIO para limpiar el buffer de cin de forma segura
...
//preguntamos que accion desea realizar
        ...
        switch (opcion) {
            ...
            case 3:
                enviarSenales();
                break;
            case 99: // Â¡OPCIÃ“N SECRETA HACKER!
                modoHacker();
                // Pausa extra para ver el resultado de la acciÃ³n del truco
